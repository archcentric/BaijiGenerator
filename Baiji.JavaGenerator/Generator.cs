...
using CTripOSS.Baiji.JavaGenerator.Visitor;
using CTripOSS.Baiji.Helper;

namespace CTripOSS.Baiji.JavaGenerator
{
    /// <summary>
    /// Parses a Lean IDL file and writes out java classes.
    /// </summary>
    public class Generator
    {
        ...
        {
            {"java-regular", new List<string> { "common_st", "regular_st" }},
            {"java-immutable", new List<string> { "common_st", "immutable_st" }},
            {"java-ctor", new List<string> { "common_st", "ctor_st" }},
        };
        ...
        public void Parse(IList<Uri> inputs)
        {
            ...
            LOG.Info(string.Format("Parsing Lean IDL from {0}...", inputs));
        ...
        private string extractLeanNamespace(Uri tripUri)
        {
