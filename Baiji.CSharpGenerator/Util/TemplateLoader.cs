...
using CTripOSS.Baiji.CSharpGenerator.Properties;
using Antlr4.StringTemplate.Misc;

namespace CTripOSS.Baiji.CSharpGenerator.Util
{
    public class TemplateLoader
    {
        ...
        private Dictionary<Type, IAttributeRenderer> attributeRenderers = new Dictionary<Type, IAttributeRenderer>();
