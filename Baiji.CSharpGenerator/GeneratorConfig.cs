...
namespace CTripOSS.Baiji.CSharpGenerator
{
    ...
    {
        /// <summary>
        /// Input base URI to load Trip IDL files.
        /// </summary>
        ...
        /// <summary>
        /// If not-null, overrides the C# namespace definitions in the IDL files.
        /// </summary>
        public string OverrideNamespace { get; private set; }
        /// <summary>
        /// If no namespace was set in the Trip IDL file, fall back to this namespace.
        /// </summary>
        ...
        /// <summary>
        /// If true, generate code for all included Trip IDLs instead of just referring to them.
        /// </summary>
